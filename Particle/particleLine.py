...
def register_normalExtra(name=None):
    def regist(func):
        ...
        def decorator(x1, y1, z1, x2, y2, z2, ticks, pulgins, particle_name, **kargs):

            pos, other = func(x1, y1, z1, x2, y2, z2, pulgins, **kargs)
            particles = []
            for p in pos:
                x, y, z = p
                particles.append(f"particle {particle_name} {x} {y} {z} 0 0 0 0 1 force")
